...
void emit_parser (void)
{
  ...
  if (found_expr) {
    pp_printf_text (pp, "#include \"act/lang/expr.h\"\n", prefix);
  }
  ...
  pp_nl;
  pp_printf_text (pp, "#include \"%s%s_parse.h\"\n", path_prefix, prefix);
  pp_printf_text (pp, "#ifdef __cplusplus\n");
  pp_printf_text (pp, "extern \"C\" {\n");
  pp_printf_text (pp, "#endif\n");
  ...
  */
  ...
  pp_printf_text (pp, "#include \"%s%s_parse.h\"\n", path_prefix, prefix);
  pp_printf_text (pp, "#include \"%s%s_parse_int.h\"\n", path_prefix, prefix);
  ...
  pp_printf_text (pp, "#include \"%s%s_parse.def\"", path_prefix, prefix); pp_nl; pp_nl;
  ...
  pp_nl;
  pp_printf_text (pp, "#include \"%s%s_parse.def\"", path_prefix, prefix); pp_nl;
  if (verilog_ids) {
